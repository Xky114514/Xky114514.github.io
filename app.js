...
let pageAnnotations = {
  ...
  "process-flow": {
    ...
    overview: "该页用三张流程图说明业务范围、采购单来源与关联关系，以及确认提交和补单流程。",
    dev: ["流程图只表达业务角色、操作顺序和判断结果，不展开技术实现。"],
    business: ["本期支持一张采购单对应一张或多张采购入库单，每张采购入库单最多关联一张采购单。", "关联采购单默认筛选同供应商近 1 天，可切换时间范围。", "存在可补单候选时展示列表、详情、补单和确认提交入口。", "当前系统状态使用待提交和已提交，观麦完成最终审核。"],
    iteration: ["2026-07-13 统一确认提交、补单和待提交口径，并将流程图精简为三张业务图。"],
  },
  "field-spec": {
    title: "字段说明 PRD",
    overview: "该页说明采购录单页面字段、采购单筛选、确认提交、补单、异常提示和验收场景。",
    dev: ["字段说明只保留业务含义、页面表现和操作规则，不展开技术实现。"],
    business: ["当前系统只负责待提交单据的核对和确认提交。", "候选弹窗展示可补单列表，同时保留独立确认提交入口。", "只有观麦尚未审核的采购单和采购入库单可以继续关联或补单。"],
  ...
  return `
    <div class="page flow-page">
      <div class="page-title flow-page-title">
        <div>
          <span class="pill blue">V0.7 · 产品评审版</span>
